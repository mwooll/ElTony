<template>
  ...
  <v-row align="center" justify="center" className="mt-1 mb-0">
    <h3 align = "center">Pokémon Comparison</h3>
  </v-row>
  <div>
  ...
  methods: {
    ...
    drawSpiderPlot(stats, clusterStats) {
      ...
      var data = [
        {
          type: 'scatterpolar',
          r: [stats.hp, stats.attack, stats.defense, stats.spAtk, stats.spDef, stats.speed, stats.hp],
          theta: ['HP', 'Attack', 'Defense', 'Sp. Atk', 'Sp. Def', 'Speed', 'HP'],
          fill: 'toself',
          name: 'Original Pokémon',
          line: { color: 'indigo' },
          text: [stats.hp, stats.attack, stats.defense, stats.spAtk, stats.spDef, stats.speed, stats.hp].map(String),
          hoverinfo: 'text',
        },
        {
          type: 'scatterpolar',
          r: [clusterStats.hp, clusterStats.attack, clusterStats.defense, clusterStats.spAtk, clusterStats.spDef, clusterStats.speed, clusterStats.hp],
          theta: ['HP', 'Attack', 'Defense', 'Sp. Atk', 'Sp. Def', 'Speed', 'HP'],
          fill: 'toself',
          name: 'Cluster Pokémon',
          line: { color: 'orange' },
          text: [clusterStats.hp, clusterStats.attack, clusterStats.defense, clusterStats.spAtk, clusterStats.spDef, clusterStats.speed, clusterStats.hp].map(String),
          hoverinfo: 'text', // Change the color of the second trace
        },

        {
          type: 'scatterpolar',
          r: [this.average.hp, this.average.attack, this.average.defense, this.average.spAtk, this.average.spDef, this.average.speed, this.average.hp],
          theta: ['HP', 'Attack', 'Defense', 'Sp. Atk', 'Sp. Def', 'Speed','HP'],
          fill: 'toself',
          name: 'Average stats of Pokémon in the unfiltered set',
          line: { color: 'grey' },
          text: [this.average.hp, this.average.attack, this.average.defense, this.average.spAtk, this.average.spDef, this.average.speed, this.average.hp].map(String),
          hoverinfo: 'text', // Change the color of the second trace
        },
      ];
